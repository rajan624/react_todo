  ...
  const [open, setOpen] = useState(false);
    ...
    const createToDo = (event) => {
        ...
        fetch("https://jsonplaceholder.typicode.com/posts", {
          ...
          .then((response) => response.json())
            .then((json) => {
                console.log(json); setToDoArray((prev) => [...prev, json])
                setLoading(false);
                setOpen(false);
            });
    }
            ...
            >
              <Stack spacing={2}>
                <FormControl>
                  ...
                  <Input defaultValue={todo.userId} name="userId" type="number" autoFocus required />
                </FormControl>
                <FormControl>
                  <FormLabel>Title</FormLabel>
                  <Input defaultValue={todo.title} name="title" type="text" required />
                </FormControl>
                <FormControl>
                  <FormLabel>Description</FormLabel>
                  <Input defaultValue={todo.body} multiline name="description" type="text" required />
                </FormControl>
